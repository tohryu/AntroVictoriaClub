        ...
        <div class="borde-ext">
            <div class="borde-int">
                ...
                <table class="fila-superior">
                    <tr>
                        <td>
                            <table class="info">
                                <tr>
                                    <td><span class="label">Precio</span><span class="valor">${{ number_format((float) $boleto->precio_unitario, 2) }}</span></td>
                    ...
                    <tr>
                        <td>
                            <table class="info" style="margin-top: 10px;">
                                <tr>
                                    <td><span class="label">Tipo</span><span class="valor valor-oro">Cover</span></td>
                                    <td><span class="label">Acceso</span><span class="valor">General</span></td>
                                    <td><span class="label">Pase</span><span class="valor">*</span></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="codigo-wrap">
                    <span class="codigo">{{ $boleto->codigo_boleto }}</span>
                </div>
                ...
                <table class="info2">
                    <tr>
                        <td><span class="label">Titular</span><span class="valor">{{ $boleto->nombre }}</span></td>
                        <td><span class="label">Método de Pago</span><span class="valor">{{ ucfirst($boleto->metodo_pago) }}</span></td>
                    </tr>
                    <tr>
                        <td><span class="label">Total Pagado</span><span class="valor" style="color:#d9b45f;">${{ number_format((float) $boleto->precio_total, 2) }} MXN</span></td>
                        <td></td>
                    </tr>
                </table>
                ...
                <div class="nota">
                    Este boleto corresponde al acceso al club y no se aplica como consumo. Es de uso único, preséntalo en recepción.
                </div>
