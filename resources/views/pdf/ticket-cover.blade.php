        ...
        <div class="borde-ext">
            <div class="borde-int">
                ...
                <table class="info">
                    ...
                    <tr>
                        <td><span class="label">Tipo</span><span class="valor valor-oscuro">Cover</span></td>
                ...
                <table class="info2">
                    ...
                    <tr>
                        <td><span class="label">Total Pagado</span><span class="valor">${{ number_format((float) $boleto->precio_total, 2) }} MXN</span></td>
                        <td></td>
                    </tr>
                </table>
