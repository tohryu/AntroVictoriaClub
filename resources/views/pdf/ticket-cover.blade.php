            ...
            <div class="borde-int">
                ...
                <div class="banda-clara">
                    ...
                    <table class="info">
                        ...
                        <tr>
                            <td><span class="label">Tipo</span><span class="valor">Cover</span></td>
                ...
                <div class="banda-media">
                    <table class="info2">
                        ...
                        <tr>
                            <td colspan="2"><span class="label">Total Pagado</span><span class="valor">${{ number_format((float) $boleto->precio_total, 2) }} MXN</span></td>
                        </tr>
                    </table>
                </div>
