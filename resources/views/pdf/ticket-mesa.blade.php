...
<body>
    ...
    <div class="ticket">
        ...
        <div class="franja">Ticket Electrónico de Reservación de Mesa</div>
                ...
                <tr>
                    <td>
                        <table class="datos">
                            ...
                            <tr><td class="label">Total Pagado</td><td class="valor precio-total">${{ number_format((float) $reserva->precio, 2) }} MXN</td></tr>
        ...
        <div class="nota">
            El monto pagado por esta mesa se aplica como consumo dentro del club la noche de tu reserva. Presenta este ticket y su código QR en recepción; el personal lo validará escaneándolo. Este ticket es de uso único.
        </div>
    </div>
</body>
</html>
